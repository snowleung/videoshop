<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="category.aspx.cs" Inherits="videoshop.admin.category" %>
          ...
          <div class="jumbotron" data-pages="parallax">
            <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
              <div class="inner">
                ...
                <Table class="table cate" id="cate">
                        <thead>
                            <tr>
                                <th>分类</th>
                            </tr>
                        ...
                        <tbody>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server"  SelectCommand="select * from cate" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\coooode\videoshop\videoshop\App_Data\videoshop_demo.mdf;Integrated Security=True;Connect Timeout=30">
                      </asp:SqlDataSource>
