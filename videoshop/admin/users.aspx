<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="videoshop.admin.users" %>
              ...
              <div class="panel-body">
                ...
                <table class="table table-hover demo-table-dynamic" id="tableWithDynamicRows">
                  ...
                  <tbody>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server"  SelectCommand="select * from users" ConnectionString="">
                        </asp:SqlDataSource>
